...
public class AbanDogController {
    ...
    @RequestMapping(value = "/onedog", method = { RequestMethod.POST }) //데이터가 보내지는 주소와 메소드 설정
    @ResponseBody
    public Object abandogone(HttpServletRequest rq){ // Object 대신에 String, list<DTO>, Map<String,Object> 등 .. 도 사용 가능
        //유기견의 이름으로 검색하여 db에서 데이터를 찾아옴
        String dogname = "임시맨"; // = rq.getParameter("abandog_name");
